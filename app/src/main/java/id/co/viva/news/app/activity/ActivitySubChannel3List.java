...
public class ActivitySubChannel3List extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sub_channel_3_list);
        ...
        args.putString(SubChannel3Fragment.BUNDLE_NAME, name);
        args.putString(SubChannel3Fragment.BUNDLE_AB_COLOR, ab_color);
        args.putString(SubChannel3Fragment.BUNDLE_API_URL, api_url);

        Fragment fragment = new SubChannel3Fragment();
        fragment.setArguments(args);

        FragmentManager fragmentManager = getSupportFragmentManager();
        fragmentManager.beginTransaction()
                .replace(R.id.container_sub_channel_3, fragment)
                .commit();
    }
