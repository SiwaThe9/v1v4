...
public class ActivityPhotoList extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        args.putString(PhotoListFragment.BUNDLE_AB_COLOR, ab_color);
        args.putString(PhotoListFragment.BUNDLE_NAME, name);
        args.putString(PhotoListFragment.BUNDLE_TITLE, title);
        args.putString(PhotoListFragment.BUNDLE_API_URL, api_url);
