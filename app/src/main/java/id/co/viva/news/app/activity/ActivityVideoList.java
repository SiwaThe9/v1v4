...
public class ActivityVideoList extends AppCompatActivity {
    ...
    public static final String EXTRA_API_URL = "extra_url";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        args.putString(VideoListFragment.BUNDLE_AB_COLOR, ab_color);
        args.putString(VideoListFragment.BUNDLE_NAME, name);
        args.putString(VideoListFragment.BUNDLE_TITLE, title);
        args.putString(VideoListFragment.BUNDLE_API_URL, api_url);
        ...
        fragmentManager.beginTransaction()
                .replace(R.id.container_video_list, fragment)
                .commit();
    }
